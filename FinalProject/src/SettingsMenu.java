...
public class SettingsMenu extends JPanel {
    public static class VolumesMenu extends JPanel {
    ...
    public static class IconMenu extends JPanel {
        JLabel XIconLabel;
        JButton XIconBtn;
        JLabel OIconLabel;
        JButton OIconBtn;
    ...
    public SettingsMenu(JFrame frame) {
        ...
        iconWrapper.setBackground(GameConstants.COLOR_BG);
        iconWrapper.setBorder(BorderFactory.createEmptyBorder(20, 0, 0, 0)); // top padding 20px
        iconWrapper.add(iconmenu, BorderLayout.CENTER);

        menus.setLayout(new BorderLayout());
        menus.add(iconWrapper, BorderLayout.NORTH);
        menus.add(volumes, BorderLayout.CENTER);
